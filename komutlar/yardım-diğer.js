...
.setFooter(`${message.author.username}`, message.author.avatarURL({ dynamic: true, format: 'png', size: 1024 }))
.setColor('BLUE') 
.setDescription(`<a:gezegen:823222531325689926> \`!!man-photo\` **Rastgele Erkek Fotoğrafı Atar.**\n\n <a:gezegen:823222531325689926> \`!!woman-photo\` **Rastgele Kadın Fotoğrafı Atar.**\n\n<a:gezegen:823222531325689926> \`!!couple-photo\` **Rastgele Sevgili Fotoğrafı Atar.**\n\n<a:gezegen:823222531325689926> \`!!animal-photo\` **Rastgele Hayvan Fotoğrafı Atar.**\n\n<a:gezegen:823222531325689926> \`!!anime-photo\` **Rastgele Anime Fotoğrafı Atar.**\n\n<a:gezegen:823222531325689926> \`!!baby-photo\` **Rastgele Bebek Fotoğrafı Atar.**`)
...
enabled: true,
guildOnly: false,
aliases: ['help-photo','yardım-photo','yardım photo'],
permLevel: 0
};
